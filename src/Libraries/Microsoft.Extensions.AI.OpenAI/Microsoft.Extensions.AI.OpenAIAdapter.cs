...
#pragma warning restore OPENAI001
                ...
                result.ResponseFormat = jsonFormat.Schema is { } jsonSchema ?
                    OpenAI.Chat.ChatResponseFormat.CreateJsonSchemaFormat(
                        ...
                        BinaryData.FromBytes(
                            JsonSerializer.SerializeToUtf8Bytes(jsonSchema, ChatClientJsonContext2.Default.JsonElement)),
    ...
    private static ChatTool ToOpenAIChatTool(AIFunction aiFunction)
    {
        ...
        var tool = JsonSerializer.Deserialize(aiFunction.JsonSchema, ChatClientJsonContext2.Default.ChatToolJson)!;
        var functionParameters = BinaryData.FromBytes(JsonSerializer.SerializeToUtf8Bytes(tool, ChatClientJsonContext2.Default.ChatToolJson));
    ...
    private static FunctionCallContent ParseCallContentFromJsonString(string json, string callId, string name) =>
        FunctionCallContent.CreateFromParsedArguments(json, callId, name,
            argumentParser: static json => JsonSerializer.Deserialize(json, ChatClientJsonContext2.Default.IDictionaryStringObject)!);
    ...
    private sealed partial class ChatClientJsonContext2 : JsonSerializerContext;
}
