...
public class InputRequestContentTests
{
    ...
    {
        Assert.Throws<ArgumentNullException>("id", () => new TestInputRequestContent(null!));
        Assert.Throws<ArgumentException>("id", () => new TestInputRequestContent(""));
        Assert.Throws<ArgumentException>("id", () => new TestInputRequestContent("\r\t\n "));
    }
