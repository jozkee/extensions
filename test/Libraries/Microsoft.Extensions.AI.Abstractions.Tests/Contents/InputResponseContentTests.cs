...
public class InputResponseContentTests
{
    ...
    {
        Assert.Throws<ArgumentNullException>("id", () => new TestInputResponseContent(null!));
        Assert.Throws<ArgumentException>("id", () => new TestInputResponseContent(""));
        Assert.Throws<ArgumentException>("id", () => new TestInputResponseContent("\r\t\n "));
    }
