...
public class FunctionInvokingChatClientApprovalsTests
{
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task AllFunctionCallsReplacedWithApprovalsMixedWithMcp(bool useAdditionalTools)
    {
        AITool[] tools =
        [
        ...
        [
            ...
            [
                ...
                new FunctionApprovalRequestContent("callId2",
                    new McpServerToolCallContent("callId2", "Func2", "myServer"))
            ])
        ];
        ...
        [
            new ChatMessage(ChatRole.Assistant,
            [
                new FunctionApprovalRequestContent("callId1",
                    new FunctionCallContent("callId1", "Func1")),
                new FunctionApprovalRequestContent("callId2",
                    new McpServerToolCallContent("callId2", "Func2", "myServer"))
            ])
    ...
    [InlineData(false)]
    [InlineData(true)]
    public async Task ApprovedMcpServerToolCallsAreExecutedAsync(bool useAdditionalTools)
    {
        AITool[] tools =
        [
            new ApprovalRequiredAIFunction(
        ...
        [
            ...
            [
                ...
                new FunctionApprovalRequestContent("callId2", new McpServerToolCallContent("callId2", "Func2", "myServer"))
            ]) { MessageId = "resp1" },
            new ChatMessage(ChatRole.User,
            [
                new FunctionApprovalResponseContent("callId1", true, new FunctionCallContent("callId1", "Func1")),
                new FunctionApprovalResponseContent("callId2", true, new McpServerToolCallContent("callId2", "Func2", "myServer"))
            ]),
        ];
    ...
    public async Task MixedApprovedAndRejectedMcpToolCallsAsync(bool useAdditionalTools, bool approveMcp)
    {
        AITool[] tools =
        [
            new ApprovalRequiredAIFunction(
        ...
        [
            ...
            new ChatMessage(ChatRole.User,
            [
                new FunctionApprovalResponseContent("callId1", !approveMcp, new FunctionCallContent("callId1", "Func1")),
                new FunctionApprovalResponseContent("callId2", approveMcp, new McpServerToolCallContent("callId2", "Func2", "myServer"))
            ]),
        ];
